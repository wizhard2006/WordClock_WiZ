...
#define WC_MEMO_SKETCH   "firmware/esp32/WordClock_ESP32/WordClock_ESP32.ino"
#define WC_MEMO_BOARD    "ESP32 Dev Module"
#define WC_MEMO_PLATFORM "ESP32"
#define WC_MEMO_UPDATE   "bouton Check for update ci-dessus, ou par cable USB"
...
// Dépôt public : les assets d'un dépôt privé exigent un jeton, l'horloge
// recevrait une erreur HTTP 404. L'URL "releases/latest" suit automatiquement
// la dernière release publiée, sans reconfigurer l'horloge.
#define DEFAULT_FW_UPDATE_URL "https://github.com/wizhard2006/WordClock_WiZ/releases/latest/download/latest.json"
    ...
    case OTA_HTTP_GET:
      {
        ...
        if (code == 200) {
          ...
          // CORRECTIF : le MD5 annoncé dans latest.json était lu puis ignoré.
          // Il est maintenant vérifié : un téléchargement corrompu est refusé et
          // l'ancien firmware reste en place.
          if (canBegin && otaCheck.md5.length() == 32) Update.setMD5(otaCheck.md5.c_str());
          if (!canBegin) {
